...
export declare abstract class CacheAdapter {
    abstract set<T>(key: string, data: T, database: string, collection: string): Promise<T>;
    abstract setBulk<T>(keys: string[], data: T[], database: string, collection: string): Promise<T[]>;
    abstract get<T>(key: string, database: string, collection: string): Promise<T | null>;
    abstract getBulk<T>(keys: string[], database: string, collection: string): Promise<T[]>;
