...
export function cacheAdapter(appName) {
    ...
    const adapters = credentials === null || credentials === void 0 ? void 0 : credentials.adapters;
    if (adapters && adapters.cache && typeof adapters.cache === "function") {
        ...
        const _adapters = (_c = config.credential(adapters.cache)) === null || _c === void 0 ? void 0 : _c.adapters;
        // @ts-ignore
