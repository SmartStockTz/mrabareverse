...
var QueryController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        response = _e.sent();
                        return [2 /*return*/, extractResultFromServer(response.data, 'delete', this.domain)];
                }
            });
        });
    };
    ...
    QueryController.prototype.changes = function (onConnect, onDisconnect, options) {
        ...
        var applicationId = getConfig().credential(this.appName).applicationId;
        var projectId = getConfig().credential(this.appName).projectId;
        var masterKey = getConfig().credential(this.appName).appPassword;
        var match;
        ...
        var socketController = new SocketController('/v2/__changes__', this.appName, function () {
    ...
    QueryController.prototype.find = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.rulesController.queryRule(this.domain, this.buildQuery(), getConfig().credential(this.appName), options)];
                    case 1:
                        queryRule = _a.sent();
