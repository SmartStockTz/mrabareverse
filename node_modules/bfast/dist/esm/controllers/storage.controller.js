...
var StorageController = /** @class */ (function () {
                ...
                if (!isBrowserLike) {
                    try {
                        if (file && file.filename && file.data) {
                            return [2 /*return*/, this._handleFileUploadInNode(file, uploadProgress, getConfig().credential(this.appName), options)];
                        }
                        else {
                    ...
                    if (file && file.data && file.data instanceof File && file.filename) {
                        return [2 /*return*/, this._handleFileUploadInWeb(file, uploadProgress, getConfig().credential(this.appName), options)];
                    }
                    else {
                        throw new Error('file object to save is invalid, data and filename is required field');
                    }
    ...
    StorageController.prototype.list = function (query, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.rulesController.storage("list", query, getConfig().credential(this.appName), options)];
                    case 1:
                        filesRule = _a.sent();
    ...
    StorageController.prototype.delete = function (filename, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.rulesController.storage("delete", { filename: filename }, getConfig().credential(this.appName), options)];
                    case 1:
                        filesRule = _a.sent();
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _b = (_a = this.httpClientController).post;
                        _c = [getConfig().databaseURL(this.appName, '/storage/' + applicationId),
                            formData,
                            {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        response = _a.sent();
                        databaseUrl = getConfig().databaseURL(this.appName, '');
