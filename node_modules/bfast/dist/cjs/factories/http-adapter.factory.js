...
var default_http_client_factory_1 = require("./default-http-client.factory");
function httpAdapter(config, appName) {
    var _a, _b, _c, _d;
    ...
    if (adapters && adapters.http && typeof adapters.http === "function") {
        ...
        var _adapters = (_d = config.credential(adapters.http)) === null || _d === void 0 ? void 0 : _d.adapters;
        // @ts-ignore
        return _adapters.http();
    }
    else {
        return new default_http_client_factory_1.DefaultHttpClientFactory();
    }
}
