    ...
    DefaultCacheFactory.prototype.getAll = function (database, collection) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (platform_util_1.isElectron || platform_util_1.isBrowser || platform_util_1.isWebWorker) {
    ...
    DefaultCacheFactory.prototype.withDexie = function (dbname, collection, fn) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(platform_util_1.isElectron || platform_util_1.isBrowser || platform_util_1.isWebWorker)) return [3 /*break*/, 5];
                        database = dbname + collection;
                        _a = dexie_1.Dexie.bind;
                        return [4 /*yield*/, sha1(database.trim())];
                    case 1:
                        db = new (_a.apply(dexie_1.Dexie, [void 0, _c.sent()]))();
