...
var syncs_util_1 = require("../utils/syncs.util");
...
var CacheController = /** @class */ (function () {
    function CacheController(appName, database, collection, cacheAdapter) {
        ...
        if (database && !database.startsWith('bfast/')) {
            this.database = (0, bfast_1.getConfig)().cacheDatabaseName(database, appName);
        }
        this.collection = (0, bfast_1.getConfig)().cacheCollectionName(collection, appName);
    }
    ...
    CacheController.prototype.addSyncs = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, syncs_util_1.addSyncs)(data, this.database, this.cacheAdapter)];
            });
        });
    };
    CacheController.prototype.removeOneSyncs = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, syncs_util_1.removeOneSyncs)(key, this.database, this.cacheAdapter)];
            });
        });
    };
    CacheController.prototype.removeAllSyncs = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, syncs_util_1.removeAllSyncs)(this.database, this.cacheAdapter)];
            });
        });
    };
    CacheController.prototype.getAllSyncs = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, syncs_util_1.getAllSyncs)(this.database, this.cacheAdapter)];
            });
        });
    };
    CacheController.prototype.getOneSyncs = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, syncs_util_1.getOneSyncs)(this.database, key, this.cacheAdapter)];
            });
        });
    };
    CacheController.prototype.getSyncsKeys = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, syncs_util_1.getSyncsKeys)(this.database, this.cacheAdapter)];
            });
        });
    };
